...
def payingdebt_off_in_ayear(balance, annual_interest_rate):
   ...
   def bal_d(balance, pay, annual_interest_rate):
       """
   ...
   while True:
       # print(bal_d(balance, payment, annual_interest_rate))
       if  bal_d(balance, payment, annual_interest_rate) > epsilon:
           payment_low = payment
       elif bal_d(balance, payment, annual_interest_rate) < -epsilon:
